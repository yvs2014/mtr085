...
#define _ASCMOD1_STR  "Mode 1 (ASCII)"
#define _ASCMOD2_STR  "Mode 2 (ASCII)"
#define _UTFMOD1_STR  "Mode 3 (Unicode)"
#define _COLORED_STR  "Colored"
#define _ASN_STR      "ASN"
...
#define CMD_Y_STR    _("toggle IP-info multi-source mode")
#define CMD_UD1_STR  _("up/down by one line")
#define CMD_UD5_STR  _("up/down by five lines")
#define PGUPDOWN_STR _("PAGE UP/DOWN")
